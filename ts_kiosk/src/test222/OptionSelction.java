...
*/
	...
	public void extra(String imgmenu, int imgprice) {
		...
		// 아이콘 생성
		ImageIcon icon = new ImageIcon("image/menu/drink/" + imgmenu + ".jpg");
		...
		menuname.setBounds(50, 300, 260, 220);
		...
		addbtn.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				newMenu[0] = temper + "/" + imgmenu + "(" + Size + ")" + "(" + TakeOut + ")";
	...
	//핫, 아이스 없는 버전
	public void extra2(String imgmenu, int imgprice) {
		...
		JPanel text1 = new JPanel();
		text1.setLayout(new FlowLayout(FlowLayout.LEFT));
		text1.add(new JLabel("1.사이즈"));
		text1.setBounds(400, 180, 70, 30);
		jp1.add(text1);

		JPanel text2 = new JPanel();
		text2.setLayout(new FlowLayout(FlowLayout.LEFT));
		text2.add(new JLabel("2.포장"));
		text2.setBounds(400, 420, 70, 30);
		jp1.add(text2);
		...
		cupsize.add(jtbregular);
		cupsize.add(jtblarge);
		cupsize.setBounds(400, 210, 300, 150);
		jp1.add(cupsize);
		...
		takeout.add(jtbmug);
		takeout.add(jtbtakeaway);
		takeout.setBounds(400, 450, 300, 150);
		jp1.add(takeout);
		...
		addbtn.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// co.setData();
				String[] newMenu = new String[3];
				newMenu[0] = imgmenu + "(" + Size + ")" + "(" + TakeOut + ")";
				newMenu[1] = Integer.toString(quncount);
				newMenu[2] = Integer.toString(imgprice);
	...
	public void Icecreamextra(String imgmenu, int imgprice) {
		...
		// 아이콘 생성
		ImageIcon icon = new ImageIcon("image/menu/icecream/" + imgmenu + ".jpg");
		imgLabel.setIcon(icon);
	...
	public void Dessertextra(String imgmenu, int imgprice) {
		...
		menuname.setBounds(30, 300, 300, 220);
		...
		ImageIcon mug = new ImageIcon("image/icon_d.png");
		ImageIcon takeaway = new ImageIcon("image/icon_t.png");

		// 선택 안되어있을때 회색 아이콘 이미지

		ImageIcon gmug = new ImageIcon("image/icon_gd.png");
		ImageIcon gtakeaway = new ImageIcon("image/icon_gt.png");
	...
	public void Cakeextra(String imgmenu, int imgprice) {
		...
		menuname.setBounds(20, 300, 330, 220);
	...
	public void ShorCakeextra(String imgmenu, int imgprice) {
		...
		ImageIcon no2 = new ImageIcon("image/icon_x2.png");
		ImageIcon no3 = new ImageIcon("image/icon_x3.png");
		ImageIcon in = new ImageIcon("image/icon_d.png");
		ImageIcon out = new ImageIcon("image/icon_t.png");
		...
		ImageIcon gno2 = new ImageIcon("image/icon_gx2.png");
		ImageIcon gno3 = new ImageIcon("image/icon_gx3.png");
		ImageIcon gin = new ImageIcon("image/icon_gd.png");
		ImageIcon gout = new ImageIcon("image/icon_gt.png");
		...
		JToggleButton jtbno2 = new JToggleButton("필요없음", gno2);
		JToggleButton jtbno3 = new JToggleButton("필요없음", gno3);
		JToggleButton jtbin = new JToggleButton("매장 이용", gin);
		JToggleButton jtbout = new JToggleButton("포장", gout);
		...
		jtbin.setBackground(Color.WHITE);
		jtbin.setHorizontalTextPosition(SwingConstants.CENTER);
		jtbin.setVerticalTextPosition(SwingConstants.BOTTOM);
		jtbin.setSelectedIcon(in);
		jtbin.addActionListener(new ActionListener() {
		...
		jtbout.setBackground(Color.WHITE);
		jtbout.setHorizontalTextPosition(SwingConstants.CENTER);
		jtbout.setVerticalTextPosition(SwingConstants.BOTTOM);
		jtbout.setSelectedIcon(out);
		jtbout.addActionListener(new ActionListener() {
		...
		text4.setLayout(new FlowLayout(FlowLayout.LEFT));
		text4.add(new JLabel("4.포장"));
		text4.setBounds(400, 770, 70, 30);
		jp1.add(text4);
		...
		JPanel jpplace = new JPanel();
		jpplace.setLayout(new FlowLayout(FlowLayout.LEFT));
		jpplace.add(jtbin);
		jpplace.add(jtbout);
		jpplace.setBounds(400, 800, 300, 150);
		jp1.add(jpplace);
